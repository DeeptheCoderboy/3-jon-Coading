					...
					<div class="app-container container-xxl d-flex align-items-center justify-content-between" id="kt_app_header_container">
						...
						<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
							...
							<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-15">
								<a href="index.html">
									<img alt="Logo" src="assets/media/logos/demo47.svg" class="h-30px d-none d-lg-inline app-header-logo-default theme-light-show" />
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="true" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_toggle">
					 ...
					 <div id="kt_app_content_container" class="app-container container-xxl">
						<div class="card-toolbar mb-2 text-end">
                            <a href="#" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#kt_modal_create_campaign">Deactivate Student</a>
                        </div>
                    
             
                <div class="row gx-4 gx-xl-10">
					<div class="col-xxl-4 mb-5">
											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-body card-body d-flex justify-content-between flex-column pt-3">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="me-5">
																...
																<a href="#" class="text-gray-800 fw-bold fs-4 me-3">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">Jaiks Doe</span>
													...
													<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">(0005) 254 254</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">johndoe@gmail.com</span>
                                        ...
                                        <div class="col-xxl-4 mb-5 ">
												...
												<div class="card-body card-body d-flex justify-content-between flex-column pt-3">
													...
													<div class="d-flex flex-stack">
														...
														<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">#124734034</span>
													...
													<div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="me-5">
																...
																<a href="#" class="text-gray-800 fw-bold fs-4 me-3">
																<i class="ki-duotone ki-user-square fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																	<span class="path3"></span>
																</i>Student Name</a>
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">John Doe</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">Male</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="me-5">
																...
																<a href="#" class="text-gray-800 fw-bold fs-4 me-3">
																<i class="ki-duotone ki-burger-menu-6 fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																	<span class="path3"></span>
																</i>Date Of Birth</a>
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">15/10/2010</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">2</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">XYZ</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">Josh Dues</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="me-5">
																...
																<a href="#" class="text-gray-800 fw-bold fs-4 me-3">
																<i class="ki-duotone ki-mouse-square fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																	<span class="path3"></span>
																</i>Dissmissal Instructions</a>
															</div>
															<!--end::Content-->
															<!--begin::Wrapper-->
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">Parent Pickup</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="me-5">
																...
																<a href="#" class="text-gray-800 fw-bold fs-4 me-3">
																<i class="ki-duotone ki-car-3 fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																	<span class="path3"></span>
																</i>Authorized To Pickup</a>
															</div>
															<!--end::Content-->
															<!--begin::Wrapper-->
															<div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="me-5">
																...
																<a href="#" class="text-gray-800 fw-bold fs-4 me-3">
																<i class="ki-duotone ki-picture fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																	<span class="path3"></span>
																</i>Photo / Video Realese</a>
															</div>
															<!--end::Content-->
															<!--begin::Wrapper-->
															<div class="d-flex align-items-center">
																<!--begin::Number-->
																<span class="text-gray-800 fw-bold text-hover-primary fs-6">Yes</span>
                                                    ...
                                                    <div class="d-flex align-items-center flex-stack flex-wrap flex-row-fluid d-grid gap-2">
															...
															<div class="me-5">
																...
																<a href="#" class="text-gray-800 fw-bold fs-4 me-3">
																<i class="ki-duotone ki-double-check fs-4 me-1">
																	<span class="path1"></span>
																	<span class="path2"></span>
																	<span class="path3"></span>
																</i>Active Status</a>
											...
											<div class="col-xxl-8 mb-5 float-end" style="margin-top: -53.3rem;">
														...
														<ul class="nav nav-stretch nav-pills nav-pills-custom d-flex mt-3">
															...
															<li class="nav-item p-0 ms-0 me-8">
																...
																<a class="nav-link btn btn-color-muted active px-0" data-bs-toggle="tab" id="kt_chart_widgets_22_tab_1" href="#kt_chart_widgets_22_tab_content_1">
																	<!--begin::Subtitle-->
																	<span class="nav-text fw-semibold fs-4 mb-3">Current (2)</span>
																	<!--end::Subtitle-->
																	<!--begin::Bullet-->
															...
															<li class="nav-item p-0 ms-0">
																...
																<a class="nav-link btn btn-color-muted px-0" data-bs-toggle="tab" id="kt_chart_widgets_22_tab_2" href="#kt_chart_widgets_22_tab_content_2">
																	<!--begin::Subtitle-->
																	<span class="nav-text fw-semibold fs-4 mb-3">Current (1)</span>
																	<!--end::Subtitle-->
																	<!--begin::Bullet-->
																	<span class="bullet-custom position-absolute z-index-2 w-100 h-2px top-100 bottom-n100 bg-primary rounded"></span>
																	<!--end::Bullet-->
													...
													<table class="table align-middle table-row-dashed fs-6 gy-3">
														...
														<thead>
															...
															<tr class="text-start  fw-bold fs-7 text-uppercase gs-0">
																<th class="min-w-20px">Program</th>
																<th class="text-end min-w-20px">Start Date</th>
																<th class="text-end min-w-20px">End Date</th>
																<th class="text-end min-w-20px">Sched. Cost</th>
																<th class="text-end min-w-20px">Payment</th>
																<th class="text-end min-w-20px">Balance</th>
														...
														<tbody class="fw-bold text-gray-600">
															...
															<tr>
																<td>
																	<a href="" class="text-gray-800 text-hover-primary">Virtual Classroom</a>
																</td>
																<td class="text-end">11/10/2020</td>
																<td class="text-end">
																	<a href="#" class="text-gray-600 text-hover-primary">11/10/2020</a>
																</td>
																<td class="text-end">
																	<span class="badge py-3 px-4 fs-7 badge-light-success">$ 49.50</span>
																	
																</td>
																<td class="text-end">
																	<span class="badge py-3 px-4 fs-7 badge-light-primary">$ 29.50</span>
																	
																</td>
																<td class="text-end">
																	<span class="badge py-3 px-4 fs-7 badge-light-danger">$ 10.00</span>
																	
																</td>
																<td class="text-end">
																	<span class="text-gray-800 fw-bolder"></span>
																</td>
                                                            ...
                                                            <tr>
																...
																<td class="text-end">15/10/2020</td>
																<td class="text-end">
																	<a href="#" class="text-gray-600 text-hover-primary">15/10/2020</a>
																</td>
																<td class="text-end">
																	<span class="badge py-3 px-4 fs-7 badge-light-success">$ 49.50</span>
																...
																<td class="text-end">
																	<span class="badge py-3 px-4 fs-7 badge-light-primary">$ 39.50</span>
